...
<body>
    ...
    <form method="post" action="./insert" enctype="multipart/form-data">
        ...
        <table>
            <tr>
                <td>图书编号：</td>
                <td><input id="xbc1913041334Id" name="xbc1913041334Id"></td>
            </tr>
            <tr>
                <td>图书名称：</td>
                <td><input id="xbc1913041334Name" name="xbc1913041334Name"></td>
            </tr>
            <tr>
                <td>图书价格</td>
                <td><input id="xbc1913041334Price" name="xbc1913041334Price"></td>
            </tr>
            <tr>
                <td>图书封面</td>
                <td><input id="photo" type="file" name="photo" value="请选择图片" /></td>
            </tr>
            <tr>
                <td></td>
                <td align="right"><input id="submit" type="submit" value="提交" /></td>
            </tr>
        </table>
    </form>
</body>